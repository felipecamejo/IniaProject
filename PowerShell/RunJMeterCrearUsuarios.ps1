# Script para ejecutar pruebas de creación de usuarios con JMeter
# Uso: .\RunJMeterCrearUsuarios.ps1 [-Mode <gui|nogui|auto>] [-GenerateReport]
...
$testPlanFile = Join-Path $scriptsDir "INIA_API_Crear_Usuarios.jmx"
...
Write-ColorOutput "    Crear Usuarios - JMeter                    " "Cyan"
Write-ColorOutput "===============================================" "Cyan"
Write-ColorOutput ""
Write-ColorOutput "Plan de Prueba: INIA_API_Crear_Usuarios" "White"
Write-ColorOutput "Modo: $Mode" "White"
Write-ColorOutput "Base URL: $BaseUrl" "White"
Write-ColorOutput ""
Write-ColorOutput "Este plan creará 3 usuarios de prueba:" "Yellow"
Write-ColorOutput "  - 1 Analista" "White"
Write-ColorOutput "  - 2 Observadores" "White"
Write-ColorOutput ""
...
if ($Mode -eq "gui") {
    ...
    Write-ColorOutput "El plan 'INIA_API_Crear_Usuarios' debería estar visible en la interfaz." "Green"
    Write-ColorOutput ""
    ...
    $resultsFile = Join-Path $resultsDir "crear-usuarios-results-$timestamp.jtl"
    $reportDir = Join-Path $reportsDir "crear-usuarios-report-$timestamp"
