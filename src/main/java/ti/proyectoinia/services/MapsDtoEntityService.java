...
public class MapsDtoEntityService {
    ...
    public PurezaDto mapToDtoPureza(Pureza pureza) {
        ...
        dto.setSemillaPuraPorcentajeInase(pureza.getSemillaPuraPorcentajeInase());
        ...
        dto.setMaterialInertePorcentaje(pureza.getMaterialInertePorcentaje());
        dto.setMaterialInertePorcentajeInase(pureza.getMaterialInertePorcentajeInase());
        ...
        dto.setOtrosCultivosPorcentaje(pureza.getOtrosCultivosPorcentaje());
        dto.setOtrosCultivosPorcentajeInase(pureza.getOtrosCultivosPorcentajeInase());
        ...
        dto.setMalezasPorcentaje(pureza.getMalezasPorcentaje());
        dto.setMalezasPorcentajeInase(pureza.getMalezasPorcentajeInase());
        ...
        dto.setMalezasToleradasPorcentaje(pureza.getMalezasToleradasPorcentaje());
        dto.setMalezasToleradasPorcentajeInase(pureza.getMalezasToleradasPorcentajeInase());
        ...
        dto.setMalezasToleranciaCeroPorcentaje(pureza.getMalezasToleranciaCeroPorcentaje());
        dto.setMalezasToleranciaCeroPorcentajeInase(pureza.getMalezasToleranciaCeroPorcentajeInase());
    ...
    public Pureza mapToEntityPureza(PurezaDto dto) {
        ...
        pureza.setSemillaPuraPorcentajeInase(dto.getSemillaPuraPorcentajeInase());
        ...
        pureza.setMaterialInertePorcentaje(dto.getMaterialInertePorcentaje());
        pureza.setMaterialInertePorcentajeInase(dto.getMaterialInertePorcentajeInase());
        ...
        pureza.setOtrosCultivosPorcentaje(dto.getOtrosCultivosPorcentaje());
        pureza.setOtrosCultivosPorcentajeInase(dto.getOtrosCultivosPorcentajeInase());
        ...
        pureza.setMalezasPorcentaje(dto.getMalezasPorcentaje());
        pureza.setMalezasPorcentajeInase(dto.getMalezasPorcentajeInase());
        ...
        pureza.setMalezasToleradasPorcentaje(dto.getMalezasToleradasPorcentaje());
        pureza.setMalezasToleradasPorcentajeInase(dto.getMalezasToleradasPorcentajeInase());
        ...
        pureza.setMalezasToleranciaCeroPorcentaje(dto.getMalezasToleranciaCeroPorcentaje());
        pureza.setMalezasToleranciaCeroPorcentajeInase(dto.getMalezasToleranciaCeroPorcentajeInase());
